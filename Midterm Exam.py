...
#Program 2. Create a program to produce the interface. After typing the name in the first text field, click the button to display the name to another text field.
